    ...
    <aside class="p-4 pt-0"
      ...
      <UCard :ui="{ body: 'grid grid-cols-5 gap-3 p-3 sm:p-3' }" class="shadow-md">
        ...
        <div class="col-span-3">
          <h2 class="text-lg font-semibold mb-2">Mercedes BT-50z : 2026</h2>
          <p class="text-sm text-gray-600 mb-4">Stay updated with the latest news and trends in the automotive industry.
          </p>
        </div>
      </UCard>
    </aside>
